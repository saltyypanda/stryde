        ...
        <div className="navbar bg-base-100 h-2">
            ...
            <div className="flex-none gap-2">
                <div className="flex-row gap-5 form-control">
                    <a href="http://localhost:3000/routines"><button class="btn w-36">Routines</button></a>
                    <a href="http://localhost:3000/workouts"><button class="btn w-36">Workouts</button></a>
                    <a href="http://localhost:3000/exercises"><button class="btn w-36">Exercises</button></a>
                </div>
